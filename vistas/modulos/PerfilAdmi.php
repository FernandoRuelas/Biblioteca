...
<div id="EditarDesc">
    <div id=infoUser>
      <div id=nomDesc>
        <form action="PerfilControlador.php" method="post">
          ...
          <input id="Guardar" disabled="true" type="submit" value="Guardar" name="Guardar"> </input> <!--onclick="inputDesc.disabled=true, Guardar.disabled=true-->
        </form>
      </div>
      ...
      <div id="editarPerfil" style="position:fixed; right: 91%; top:60%;">      
        <td><input type="submit" value="Editar perfil" name="Editar" onclick="inputDesc.disabled=false, Guardar.disabled=false"></td>
      </div>
    ...
    <form action="PerfilAdmiControlador.php" method="post">
      ...
      <table>
        ...
        <tr>
          ...
          <td> <input id="userBox" type="text" name="DisponibilidadLibro"> </td>
